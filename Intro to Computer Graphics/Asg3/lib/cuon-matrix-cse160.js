...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        s=other1.elements;
        v2=other2.elements;
        let vec=[s[1]*v2[2]-s[2]*v2[1] ,s[2]*v2[0]-s[0]*v2[2] ,s[0]*v2[1]-s[1]*v2[0]]
        let v3 = new Vector3(vec); // Modify this line to calculate cross product between other1 and other2.
